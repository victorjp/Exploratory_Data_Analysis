...
```
Finally since Alcohol is the conversion from sugar, I was expecting
a stronger relationship in residual sugar and alcohol. There seems to be
a pattern in the max residual sugar the higher the alcohol, but his does 
not holds true for the minimal levels that seems to be spread out. This also
could be function of the process used to make the wine.
...
Having said that, I picked density to 

### Did you observe any interesting relationships between the other features \
The acidity variables seems to have some relationship. However the sulfate
and sulphates variables does not seem to be related. Finally the residual sugar
altough is not strongly related to alcohol, we observed a patter where the max
residual sugar reduces with increasing amounts of alcohol.
